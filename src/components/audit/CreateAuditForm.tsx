...
export function CreateAuditForm() {
  ...
  if (!open) {
    return (
      <button onClick={() => setOpen(true)}
        className="flex items-center gap-2 px-5 py-2.5 bg-[#0f172a] text-white rounded-lg text-sm font-medium hover:bg-[#1e293b]">
  ...
  return (
    <div className="bg-white rounded-2xl border border-[#e2e8f0] p-6 shadow-sm max-w-md mx-auto mt-4">
      <h2 className="text-lg font-semibold text-[#0f172a] mb-4">Create New Audit</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex justify-end gap-2 pt-2">
          <button type="button" onClick={() => setOpen(false)}
            className="px-4 py-2.5 text-sm text-[#475569] hover:bg-[#f1f5f9] rounded-xl">Cancel</button>

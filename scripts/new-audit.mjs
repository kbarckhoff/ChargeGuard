...
// Usage:  node scripts/new-audit.mjs ["Review Name"] ["Entity Name"]
// Defaults: "CDM Validation" / "Sample Hospital"
import { readFileSync } from "node:fs";
import { createClient } from "@supabase/supabase-js";

const NAME = process.argv[2] || "CDM Validation";
const HOSPITAL = process.argv[3] || "Sample Hospital";
...
const { data, error } = await admin.rpc("create_audit_with_phases", {
  ...
  p_description: "CDM validation review",
...
console.log("   Next: refresh Charge Master, import the CDM CSV, then Scan from the Dashboard.");
